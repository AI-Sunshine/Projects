...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***" 
    '''Edited space in Problem 5 due to method for implementing play function.
    Passed all 7 test cases for Problem 6.'''
    # END PROBLEM 6
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def comment(score0, score1):
        ...
        change_score = current_score - last_score
        if change_score > 0 and change_score > running_high:
            print(str(change_score) + " point(s)!" + " The most yet for Player " + str(who))
        return announce_highest(who, current_score, max(change_score, running_high))
    return comment
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average_value(*args):
        called_trial = 0
        finish = 0
        while called_trial < trials_count:
            finish += original_function(*args)
            called_trial += 1
        return finish / trials_count
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(zero_score, opponent_score):
        return 0
